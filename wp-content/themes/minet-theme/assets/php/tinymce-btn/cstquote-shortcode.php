...
if ( ! function_exists( 'swp_add_buttons' ) ) {
  function swp_add_buttons( $plugin_array ) {
      $plugin_array['simple-quote'] = get_stylesheet_directory_uri().'/assets/php/tinymce-btn/cstquote-shortcode.js';
      $plugin_array['complex-quote'] = get_stylesheet_directory_uri().'/assets/php/tinymce-btn/cstquote-shortcode.js';
      return $plugin_array;
  }
}
...
if ( ! function_exists( 'swp_register_buttons' ) ) {
  function swp_register_buttons( $buttons ) {
      array_push( $buttons, 'simple-quote' );
      array_push( $buttons, 'complex-quote' );
      return $buttons;
  }
}
