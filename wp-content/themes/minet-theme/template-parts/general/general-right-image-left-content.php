<div class="rilc">
    ...
    <div class="flex-row">
      ...
      <div class="flex-item item50 info_item">
        <?php if(!empty($args->title)): ?>
          <div class="section__title right_title" data-inviewport="section-title"><h2 class="section-title"><?php echo $args->title; ?></h2><svg width="74px" height="45px"><use xlink:href="#section-title"></use></svg></div>
        <?php endif; ?>
  ...
  <svg data-inViewport="vector" class="vector" width="475px" height="288px"><use xlink:href="#minet-big-vector-white"></use></svg>
</div>
