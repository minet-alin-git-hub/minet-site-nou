...
<main class="technology">
  ...
  <?php if (get_field('image_screen_visibility') == true) : ?>
    <?php get_template_part('template-parts/general/general', 'one-image-screen', get_field('image_screen_image')); ?>
  <?php endif; ?>
  ...
  <?php
  $button_group = get_field('ti_button'); // Group field
  if ($button_group):
